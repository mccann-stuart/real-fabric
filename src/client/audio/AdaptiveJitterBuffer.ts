...
/** SEC-10: maximum frames allowed in jitter buffer to prevent burst DoS. */
...
export class AdaptiveJitterBuffer<T> {
  ...
  push(frame: BufferedFrame<T>): void {
    ...
    // SEC-10: reject frames when buffer capacity is exhausted to bound memory and CPU work.
