...
| Security hardening landed (SEC-04–SEC-10) | Viewer-specific routing projection, anonymous partial-context state, in-message WebSocket auth, 1 active socket/participant, IP join rate limit, 32 KiB body stream limit, deduplication and media-burst bounds |
...
- Automated test coverage stands at 300 passing tests across twenty files.
