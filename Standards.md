...
| iPhone below iOS 27 or Safari 27 | Safari | **Read-only.** | Upgrade to the declared floor; no compatibility downgrade is provided. |
| iPhone | Chrome, Firefox, Edge, Opera, embedded web views or installed Home Screen mode | **Read-only.** Shared WebKit ancestry is not acceptance evidence. | Separate lifecycle and real-device scope. |
